<?php
//000000000000s:155731:"<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div id="warpper" class="clearfix">
  <div id="path-new" class="clearfix colaaa text13">
    <div class="item fl">
      <div class="fl">
        <span class="u-nav-title"> <a href="javascript:void(0);">鞋、箱包、珠宝、手表</a> 
        </span>
      </div>
    ...
    <div class="attrs"> 
      ...
      <div class='m-tr' >
        ...
        <div class='g-right ' >
          <div class="g-list">
            <ul class="f-list h76 ">
              <li> <a href="/index.php/Home/Goods/goodsList/id/51/price/0-1720" data-attr-desc=''><i></i>1720以下元</a> </li><li> <a href="/index.php/Home/Goods/goodsList/id/51/price/1720-3440" data-attr-desc=''><i></i>1720-3440元</a> </li>			  <li class="m-pricebox">
  ...
  <ul id="cata_choose_product" class="cart_containt clearfix listContainer">
    <li>
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">六福珠宝足金心形DIY刻字片吊坠黄金项链手链挂饰计价GMGTBP0056</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">六福珠宝足金DIY刻字片挂饰黄金项链吊坠手链挂饰计价GMGTBP0057</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">CNUTI粤通国际珠宝 黄金首饰 足金花生吊坠 男女同款 宝宝礼物 约1.25克左右</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">金地珠宝足金花之恋金花3D硬金吊坠优雅大方时尚百搭唯美花朵黄金吊坠项坠</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">六福珠宝足金百搭满天星链黄金项链女2015新款(计价)B01TBGN0009</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">Hundred Generation 佰黛 天然南非钻石情侣对戒 公主戒指 情侣钻戒镀铂金戒指 婚戒款式定做</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">珂兰钻石 18K金90分效果群镶钻石戒指 倾城 需定制</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
