<?php
//000000000000s:163135:"<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div id="warpper" class="clearfix">
  <div id="path-new" class="clearfix colaaa text13">
    <div class="item fl">
      <div class="fl">
        <span class="u-nav-title"> <a href="javascript:void(0);">个人化妆</a> 
        </span>
      </div>
    ...
    <div class="attrs"> 
      ...
      <div class='m-tr' >
        ...
        <div class='g-right ' >
          <div class="g-list">
            <ul class="f-list h76 ">
              <li> <a href="/index.php/Home/Goods/goodsList/id/45/price/0-1200" data-attr-desc=''><i></i>1200以下元</a> </li>			  <li class="m-pricebox">
  ...
  <ul id="cata_choose_product" class="cart_containt clearfix listContainer">
    <li>
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">香奈儿 /CHANEL 粉色邂逅柔情女士持久淡香水 35ML 法国进口</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">Versace范思哲 晶钻 女用香水 30ml</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">迪奥迪奥小 姐花漾淡香氛5ml</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">香奈儿邂逅清新淡香水 100ml</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">泊泉雅男士女士香水50ml 淡香清新持久留香 淡雅香氛诱惑 正品</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">CHANEL香奈儿 绿色邂逅 清新气息机会女士香水 EDT 35ML 进口</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">凯卓纯净之水男用香水 30ml</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">CHANEL香奈儿 粉色邂逅柔情女士淡香水 EDT 50ML</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
        ...
        <div class="listbox clearfix"> 
          ...
          <!-- 价格 end--> 
          <!-- 品名 -->
          <div class="listDescript"> <a target="_blank" href="http://www.tp-shop.cn/item/201510CM130003397" class="text13">竹萃集自由中性香水 薰衣草琥珀檀香橙花味持久淡香正品男女通用</a> </div>
          <!-- 價格及字樣 -->
          <div class="itemPrice" >
